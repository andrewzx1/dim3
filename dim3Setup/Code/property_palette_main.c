...
void property_palette_fill_main(void)
{
	...
	list_palette_add_item(&property_palette,item_interface_intro,0,"Intro",(state.cur_item==item_interface_intro),FALSE);
	list_palette_add_item(&property_palette,item_interface_setup,0,"Setup",(state.cur_item==item_interface_setup),FALSE);
