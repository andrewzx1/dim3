...
void model_setup(file_path_setup_type *file_path_setup,bool anisotropic,int mipmap_mode,bool in_engine,bool shader_on)
{
	memmove(&modelutility_settings.file_path_setup,file_path_setup,sizeof(file_path_setup_type));
	modelutility_settings.anisotropic=anisotropic;
