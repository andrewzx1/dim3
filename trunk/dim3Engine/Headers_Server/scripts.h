...
extern JSObjectRef script_add_camera_chase_angle_object(JSContextRef cx,JSObjectRef parent_obj);
extern JSObjectRef script_add_camera_chase_offset_object(JSContextRef cx,JSObjectRef parent_obj);
