...
JSObjectRef script_add_utility_angle_object(JSContextRef cx,JSObjectRef parent_obj,attach_type *attach)
{
	return(script_create_child_object(cx,parent_obj,utility_angle_class,"angle",attach));
}
