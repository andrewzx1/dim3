...
bool js_camera_chase_angle_get_x(JSContext *cx,JSObject *j_obj,jsval id,jsval *vp)
{
	*vp=script_float_to_value(camera.chase_ang.x);
	return(JS_TRUE);
}

bool js_camera_chase_angle_get_y(JSContext *cx,JSObject *j_obj,jsval id,jsval *vp)
{
	*vp=script_float_to_value(camera.chase_ang.y);
	return(JS_TRUE);
}

bool js_camera_chase_angle_get_z(JSContext *cx,JSObject *j_obj,jsval id,jsval *vp)
{
...
bool js_camera_chase_angle_set_x(JSContext *cx,JSObject *j_obj,jsval id,jsval *vp)
{
	camera.chase_ang.x=script_value_to_float(*vp);
	return(JS_TRUE);
}

bool js_camera_chase_angle_set_y(JSContext *cx,JSObject *j_obj,jsval id,jsval *vp)
{
	camera.chase_ang.y=script_value_to_float(*vp);
	return(JS_TRUE);
}

bool js_camera_chase_angle_set_z(JSContext *cx,JSObject *j_obj,jsval id,jsval *vp)
{
