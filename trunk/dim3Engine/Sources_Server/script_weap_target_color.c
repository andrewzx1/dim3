...
JSObjectRef script_add_weap_target_color_object(JSContextRef cx,JSObjectRef parent_obj,attach_type *attach)
{
	return(script_create_child_object(cx,parent_obj,weap_target_color_class,"color",attach));
}
