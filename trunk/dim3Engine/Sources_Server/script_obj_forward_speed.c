...
JSStaticValue 		obj_forward_speed_props[]={
							...
							{"run",						js_obj_forward_speed_get_run,				js_obj_forward_speed_set_run,				kJSPropertyAttributeDontDelete},
							{"crawl",					js_obj_forward_speed_get_crawl,				js_obj_forward_speed_set_crawl,				kJSPropertyAttributeDontDelete},
							{"air",						js_obj_forward_speed_get_air,				js_obj_forward_speed_set_air,				kJSPropertyAttributeDontDelete},
							{"acceleration",			js_obj_forward_speed_get_acceleration,		js_obj_forward_speed_set_acceleration,		kJSPropertyAttributeDontDelete},
							{"deceleration",			js_obj_forward_speed_get_deceleration,		js_obj_forward_speed_set_deceleration,		kJSPropertyAttributeDontDelete},
							{"accelerationAir",			js_obj_forward_speed_get_accelerationAir,	js_obj_forward_speed_set_accelerationAir,	kJSPropertyAttributeDontDelete},
							{"decelerationAir",			js_obj_forward_speed_get_decelerationAir,	js_obj_forward_speed_set_decelerationAir,	kJSPropertyAttributeDontDelete},
							{0,0,0,0}};
...
{
	obj_forward_speed_class=script_create_class("obj_forward_speed_class",obj_forward_speed_props,NULL);
}
...
JSObjectRef script_add_obj_forward_speed_object(JSContextRef cx,JSObjectRef parent_obj,attach_type *attach)
{
	return(script_create_child_object(cx,parent_obj,obj_forward_speed_class,"forwardSpeed",attach));
}
...
JSValueRef js_obj_forward_speed_get_decelerationAir(JSContextRef cx,JSObjectRef j_obj,JSStringRef name,JSValueRef *exception)
{
	...
	obj=object_get_attach(j_obj);
	return(script_float_to_value(cx,obj->forward_move.air_decelerate));
}
