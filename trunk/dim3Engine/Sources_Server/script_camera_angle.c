...
JSObjectRef script_add_camera_angle_object(JSContextRef cx,JSObjectRef parent_obj,attach_type *attach)
{
	return(script_create_child_object(cx,parent_obj,camera_angle_class,"angle",attach));
}
