...
JSObjectRef script_add_global_utility_object(JSContextRef cx,JSObjectRef parent_obj,int script_idx)
{
	return(script_create_child_object(cx,parent_obj,utility_class,"utility",script_idx));
}
