...
JSObjectRef script_add_game_setting_object(JSContextRef cx,JSObjectRef parent_obj,attach_type *attach)
{
	return(script_create_child_object(cx,parent_obj,game_setting_class,"setting",attach));
}
