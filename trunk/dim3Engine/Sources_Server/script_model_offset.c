...
JSObjectRef script_add_model_offset_object(JSContextRef cx,JSObjectRef parent_obj,attach_type *attach)
{
	return(script_create_child_object(cx,parent_obj,model_offset_class,"offset",attach));
}
