...
JSBool js_weap_crosshair_color_get_property(JSContext *cx,JSObject *j_obj,jsval id,jsval *vp);
JSBool js_weap_crosshair_color_set_property(JSContext *cx,JSObject *j_obj,jsval id,jsval *vp);
...
bool js_weap_crosshair_color_get_red(JSContext *cx,JSObject *j_obj,jsval id,jsval *vp)
{
	weapon_type		*weap;
...
bool js_weap_crosshair_color_get_green(JSContext *cx,JSObject *j_obj,jsval id,jsval *vp)
{
	weapon_type		*weap;
...
bool js_weap_crosshair_color_get_blue(JSContext *cx,JSObject *j_obj,jsval id,jsval *vp)
{
	weapon_type		*weap;
...
bool js_weap_crosshair_color_set_red(JSContext *cx,JSObject *j_obj,jsval id,jsval *vp)
{
	weapon_type		*weap;
...
bool js_weap_crosshair_color_set_green(JSContext *cx,JSObject *j_obj,jsval id,jsval *vp)
{
	weapon_type		*weap;
...
bool js_weap_crosshair_color_set_blue(JSContext *cx,JSObject *j_obj,jsval id,jsval *vp)
{
	weapon_type		*weap;
