...
JSBool js_proj_motion_vector_get_property(JSContext *cx,JSObject *j_obj,jsval id,jsval *vp);
JSBool js_proj_motion_vector_set_property(JSContext *cx,JSObject *j_obj,jsval id,jsval *vp);
...
JSObject* script_add_proj_motion_vector_object(JSObject *parent_obj)
{
...
JSBool js_proj_motion_vector_get_property(JSContext *cx,JSObject *j_obj,jsval id,jsval *vp)
{
	return(script_get_property(cx,j_obj,id,vp,proj_motion_vector_props));
}

JSBool js_proj_motion_vector_set_property(JSContext *cx,JSObject *j_obj,jsval id,jsval *vp)
{
	return(script_set_property(cx,j_obj,id,vp,proj_motion_vector_props));
}
...
bool js_proj_motion_vector_get_x(JSContext *cx,JSObject *j_obj,jsval id,jsval *vp)
{
	proj_type			*proj;
...
bool js_proj_motion_vector_get_y(JSContext *cx,JSObject *j_obj,jsval id,jsval *vp)
{
	proj_type			*proj;
...
bool js_proj_motion_vector_get_z(JSContext *cx,JSObject *j_obj,jsval id,jsval *vp)
{
	proj_type			*proj;
