...
JSObjectRef script_add_proj_motion_vector_object(JSContextRef cx,JSObjectRef parent_obj)
{
	return(script_create_child_object(cx,parent_obj,proj_motion_vector_class,"motionVector",proj_motion_vector_props,NULL));
}
