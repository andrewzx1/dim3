...
int				win32_menu_remap[][2]={
					...
					{kCommandMapAddCinema,401},
					{kCommandMapAddGroup,402},
					{kCommandMapAddMovement,403},
					{kCommandMapRaiseY,404},
					{kCommandMapLowerY,405},
					{kCommandMapCenter,406},
					{kCommandMapResetUV,407},
					{kCommandMapOptimize,408},
					{kCommandMapCreateNormals,409},
					{kCommandClearLightMaps,410},
					{kCommandBuildLightMaps,411},
					{kCommandRun,412},
