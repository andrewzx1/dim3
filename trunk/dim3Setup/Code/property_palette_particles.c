...
void property_palette_fill_particles(void)
{
	...
	list_palette_add_header_button(&property_palette,kParticlePropertyGroupAdd,"Particle Groups",list_button_plus);
...
void property_palette_click_particles(bool double_click)
{
	int					id,idx,sz;
