...
extern bool bitmap_open(bitmap_type *bitmap,char *path,int anisotropic_mode,int mipmap_mode,bool pixelated,bool scrub_black_to_alpha);
extern bool bitmap_color(bitmap_type *bitmap,d3col *col);
extern bool bitmap_data(bitmap_type *bitmap,unsigned char *data,int wid,int high,bool alpha_channel,int anisotropic_mode,int mipmap_mode);
