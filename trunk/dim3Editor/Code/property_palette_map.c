...
void property_palette_fill_map(void)
{
	...
	list_palette_add_uv(&property_palette,kMapPropertyEditorTextureFactor,"Texture Scale (1000 units)",&map.editor_setup.txt_scale_x,&map.editor_setup.txt_scale_y,FALSE);
