...
extern unsigned char* view_pick_list_multiple_get_pixels(editor_view_type *view);
extern int view_pick_list_multiple_pick(editor_view_type *view,unsigned char *pixels,d3pnt *start_pnt,d3pnt *end_pnt,int *type,int *main_idx,int *sub_idx,int max_item);
extern void view_pick_list_multiple_end(unsigned char *pixels);
...
extern void walk_view_click_piece_map_pick_start(editor_view_type *view);
