...
extern int net_host_player_join(d3socket sock,char *name,int tint_color_idx,int character_idx,char *deny_reason);
...
extern void net_client_send_click(int remote_uid,d3pnt *pt,d3ang *ang);
