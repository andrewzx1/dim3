...
extern void element_model_add(char *name,char *animate,float resize,d3pnt *offset,int id,int x,int y);
...
extern bool element_replace_model(int id,char *name,char *animate,float resize,d3pnt *offset);
