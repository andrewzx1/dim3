...
JSClass				*weap_crosshair_pickup_color_class;
...
{
	script_create_child_object(parent_obj,weap_crosshair_pickup_color_class,"pickupColor",weap_crosshair_pickup_color_props,NULL);
}
