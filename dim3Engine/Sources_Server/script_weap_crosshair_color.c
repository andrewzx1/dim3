...
JSClass				*weap_crosshair_color_class;
...
void script_add_weap_crosshair_color_object(JSObject *parent_obj)
{
	script_create_child_object(parent_obj,weap_crosshair_color_class,"color",weap_crosshair_color_props,NULL);
}
