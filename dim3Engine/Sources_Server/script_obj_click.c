...
JSBool js_obj_click_get_property(JSContextRef cx,JSObject *j_obj,JSValueRef id,JSValueRef *vp);
JSBool js_obj_click_set_property(JSContextRef cx,JSObject *j_obj,JSValueRef id,JSValueRef *vp);
bool js_obj_click_get_crosshairUp(JSValueRef *vp);
bool js_obj_click_get_crosshairDown(JSValueRef *vp);
bool js_obj_click_get_objectId(JSValueRef *vp);
bool js_obj_click_get_objectName(JSValueRef *vp);
...
JSObject* script_add_obj_click_object(JSObject *parent_obj)
{
...
JSBool js_obj_click_get_property(JSContextRef cx,JSObject *j_obj,JSValueRef id,JSValueRef *vp)
{
	return(script_get_property(cx,j_obj,id,vp,obj_click_props));
}

JSBool js_obj_click_set_property(JSContextRef cx,JSObject *j_obj,JSValueRef id,JSValueRef *vp)
{
	return(script_set_property(cx,j_obj,id,vp,obj_click_props));
}
