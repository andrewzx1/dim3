...
JSObjectRef script_add_obj_rigid_body_object(JSContextRef cx,JSObjectRef parent_obj,int script_idx)
{
	return(script_create_child_object(cx,parent_obj,obj_rigid_body_class,"rigidBody",script_idx));
}
