...
JSObjectRef script_add_interface_screen_object(JSContextRef cx,JSObjectRef parent_obj,attach_type *attach)
{
	return(script_create_child_object(cx,parent_obj,interface_screen_class,"screen",attach));
}
