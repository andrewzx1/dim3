...
void bitmap_text_size_internal(texture_font_size_type *d3_size_font,char *name,int size,int bitmap_wid,int bitmap_high)
{
	...
	bitmap_data(&d3_size_font->bitmap,txt_data,bitmap_wid,bitmap_high,TRUE,mipmap_mode_none,FALSE,FALSE);
...
void bitmap_text_size_internal(texture_font_size_type *d3_size_font,char *name,int size,int bitmap_wid,int bitmap_high)
{
	...
	bitmap_data(&d3_size_font->bitmap,data,bitmap_wid,bitmap_high,TRUE,mipmap_mode_none,FALSE,FALSE);
	free(data);
}
