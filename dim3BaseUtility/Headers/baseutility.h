...
extern bool bitmap_ag_texture_tile(texture_frame_type *frame,char *base_path,int pixel_sz);
extern bool bitmap_ag_texture_metal(texture_frame_type *frame,char *base_path,int pixel_sz);
