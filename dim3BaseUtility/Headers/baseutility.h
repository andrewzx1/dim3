...
extern bool bitmap_ag_texture_brick(texture_frame_type *frame,char *base_path,char *name,int pixel_sz);
extern bool bitmap_ag_texture_tile(texture_frame_type *frame,char *base_path,char *name,int pixel_sz);
extern bool bitmap_ag_texture_metal(texture_frame_type *frame,char *base_path,char *name,int pixel_sz);
extern bool bitmap_ag_texture_wood(texture_frame_type *frame,char *base_path,char *name,int pixel_sz);
extern bool bitmap_ag_texture_cement(texture_frame_type *frame,char *base_path,char *name,int pixel_sz);
extern bool bitmap_ag_texture_window(texture_frame_type *frame,char *base_path,char *name,int pixel_sz);
extern bool bitmap_ag_texture_machine(texture_frame_type *frame,char *base_path,char *name,int pixel_sz);
