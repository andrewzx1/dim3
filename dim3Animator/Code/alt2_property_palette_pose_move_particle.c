...
Author: Brian Barnes
 Usage: Alt Property Palette Animate Pose Move Particle
...
/* =======================================================
      ...
      Alt Property Palette Fill Animate Pose Move Particle
      
======================================================= */

void alt2_property_palette_fill_animate_pose_move_particle(int animate_idx,int pose_move_idx,int particle_idx)
{
	...
	list_palette_add_checkbox(&alt2_property_palette,kAnimationPoseMovePropertyParticleRotate,"Follow Model Rotation",&particle->rotate,FALSE);
	list_palette_add_checkbox(&alt2_property_palette,kAnimationPoseMovePropertyParticleStick,"Follow Model Bone",&particle->stick,FALSE);
	list_palette_add_point(&alt2_property_palette,kAnimationPoseMovePropertyParticleSlop,"Position Slop",&particle->slop,FALSE);
}

/* =======================================================

      Alt Property Palette Click Animate Pose Move Particle
      
======================================================= */

void alt2_property_palette_click_animate_pose_move_particle(int animate_idx,int pose_move_idx,int particle_idx,int id,bool double_click)
{
	model_animate_type		*animate;
	model_pose_move_type	*pose_move;
	model_particle_type		*particle;
