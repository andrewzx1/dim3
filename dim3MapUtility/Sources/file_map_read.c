...
void decode_map_settings_xml(map_type *map,int map_head)
{
    ...
    if (tag!=-1) {
		...
		map->editor_setup.view_near_dist=xml_get_attribute_int_default(tag,"view_near_dist",860);
		map->editor_setup.view_far_dist=xml_get_attribute_int_default(tag,"view_far_dist",288000);
