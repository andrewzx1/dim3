...
extern void walk_view_click_snap(int mesh_idx,d3pnt *pt,d3pnt *mpt);
extern void walk_view_click_snap_poly(int mesh_idx,int poly_idx,d3pnt *old_pts,d3pnt *mpt);
extern void walk_view_click_snap_mesh(int mesh_idx,d3pnt *old_pts,d3pnt *mpt);
...
extern bool walk_view_click_drag_area_vertex(editor_3D_view_setup *view_setup,d3pnt *pt,int view_move_dir);
...
extern bool walk_view_click_drag_area(editor_3D_view_setup *view_setup,d3pnt *pt,int view_move_dir);
...
extern void walk_view_mouse_yz_movement(editor_3D_view_setup *view_setup,d3pnt *pt,int view_move_dir);
