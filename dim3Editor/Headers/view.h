...
extern bool view_model_draw(d3pnt *pnt,d3ang *ang,char *name,short *texture_frame,int frame_count);
extern void view_model_cube_vertexes(char *name,d3pnt *pnt,d3ang *ang,d3pnt *v_pnts);
