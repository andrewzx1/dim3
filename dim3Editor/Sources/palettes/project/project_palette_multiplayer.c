...
void project_palette_fill_multiplayer(void)
{
	...
	for (n=0;n!=iface.multiplayer.game_list.ngame;n++) {
		list_palette_add_string_selectable_button(&project_palette,(kMPPropertyGameName+n),list_button_minus,(kMPPropertyGameDelete+n),iface.multiplayer.game_list.games[n].name,(state.proj.cur_multiplayer_game_idx==n),FALSE,FALSE);
	}
	...
	for (n=0;n!=iface.multiplayer.option_list.noption;n++) {
		list_palette_add_string_selectable_button(&project_palette,(kMPPropertyOptionName+n),list_button_minus,(kMPPropertyOptionDelete+n),iface.multiplayer.option_list.options[n].name,(state.proj.cur_multiplayer_option_idx==n),FALSE,FALSE);
	}
	...
	for (n=0;n!=iface.multiplayer.character_list.ncharacter;n++) {
		list_palette_add_string_selectable_button(&project_palette,(kMPPropertyCharacterName+n),list_button_minus,(kMPPropertyCharacterDelete+n),iface.multiplayer.character_list.characters[n].name,(state.proj.cur_multiplayer_character_idx==n),FALSE,FALSE);
	}
